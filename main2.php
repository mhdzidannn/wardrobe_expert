	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item"><a href="profile.php" class="nav-link" ><font color=#F56A57  size='2pt'><b><i>Profile</b></i></font></a></li>
	          <li class="nav-item"><a href="myorder.php" class="nav-link"><font color=#F56A57  size='2pt'><b><i>My Order</b></i></font></a></li>
...
<body >
	...
	<div class="container">
				<div class="row justify-content-center mb-3 pb-3">
					...
					<div class="w-100"><h3 class="monospace" style="color:DarkBlue"> <b>Choose Your Event<b/> </h3></div><br> <br>
