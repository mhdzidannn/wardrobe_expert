	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="myorder.php" class="nav-link"><font color=#F56A57  size='2pt'><b><i>Feedback</b></i></font></a></li>
			...
			<div class="container">
				<div class="row justify-content-center mb-3 pb-3">
					<div class="col-md-12 heading-section text-center ftco-animate">
							<h2 class="monospace" style="color:black">My Profile</h2><br><br>
							<main>
                <div>
                          <div>
                    <table class="table">
